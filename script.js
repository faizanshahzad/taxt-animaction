...
const App = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("h1", { ref: h1Ref, style: { '--color': color, '--speed': speed, '--size': image } },
    txt), /*#__PURE__*/

    React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", ref: svgRef, viewBox: `0 0 ${width} ${height}` }, /*#__PURE__*/
    React.createElement("filter", { id: "magnify" }, /*#__PURE__*/
